...
export default function Home() {
  return(
    <div className="flex flex-col justify-center items-center space-y-5 h-32">
      <div className="brand flex items-center space-x-2">
        <svg className="!w-10" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="icon" fill="#ffffff" transform="translate(42.666667, 64.000000)">
        ...
        <span className="text-4xl mb-1">moontrip</span>
      </div>
      <Link
        className={'btn text-white bg-gradient-to-tl from-violet-400 via-violet-900 to-violet-600 border-transparent rounded-full hover:shadow-lg'}
        href="/dashboard"
      >Access</Link>
    </div>
  )
